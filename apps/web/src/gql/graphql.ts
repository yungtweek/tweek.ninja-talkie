...
export type Message = {
  ...
  ragSearchJson?: Maybe<Scalars['String']['output']>;
  role: Scalars['String']['output'];
  sourcesJson?: Maybe<Scalars['String']['output']>;
  toolCallsJson?: Maybe<Scalars['String']['output']>;
